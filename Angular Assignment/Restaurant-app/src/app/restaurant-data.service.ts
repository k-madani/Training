...
export class RestaurantDataService  {
  ...
  res1=new Restaurant("Fusion Kitchen",new Menu("Over Laden Nachos",200));
  res2=new Restaurant("Little West Pizza ",new Menu("Garlic bread",100));
  res3=new Restaurant("Banjara Dhabha",new Menu("Paneer Tikka masala",300));
